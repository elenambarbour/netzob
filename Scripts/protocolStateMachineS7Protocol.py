...
combMessage = PCAPImporter.readFile("./DataFiles/S7-1511_db6w0_HMI.pcap").values()#messages_1 + messages_2

print('Raw for of PCAP using xxd')
os.system("xxd ./DataFiles/S7-1511_db6w0_HMI.pcap")#target_src_v1_session2.pcap")
